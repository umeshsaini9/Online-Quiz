...
void set() 
{
	...
	if(current==0) 
	{
		l.setText("Que 1: which one among these is not a primitive datatype?");
		jb[0].setText("int");
		jb[1].setText("Float");
	...
	if(current==1)
	{
		l.setText("Que 2: Which class is available to all the class automatically?");
		jb[0].setText("Swing");
		jb[1].setText("Applet");
		jb[2].setText("Object");
	...
	if(current==3) 
	{
		l.setText("Que 4: String class is defined in which package? ");
		jb[0].setText("lang");
		jb[1].setText("swing");;
		jb[2].setText("applet");
		jb[3].setText("awt");
	...
	if(current==5) {
		l.setText("Que 6: Which one among these is not a keyword?");
		jb[0].setText("class");
		jb[1].setText("int");
		jb[2].setText("get");
		jb[3].setText("if");
	...
	if(current==6)
	{
		l.setText("Que 7: Which one among these is not a class?");
		jb[0].setText("swing");
		jb[1].setText("ActionPerfirmed");
	...
	if(current==9)
	{
		l.setText("Que 10: Which one among these is not a valid component?");
